...
glBufferStorage = GL('glBufferStorage', None, UInt, Size, VoidP, UInt)
glClearTexImage = GL('glClearTexImage', None, UInt, Int, UInt, UInt, VoidP)
glClearTexSubImage = GL(
    'glClearTexSubImage', None, UInt, Int, Int, Int, Int, Int, Int, Int, UInt,
    UInt, VoidP
)
glBindBuffersBase = GL('glBindBuffersBase', None, UInt, UInt, Int, P(UInt))
glBindBuffersRange = GL(
    'glBindBuffersRange', None, UInt, UInt, Int, P(UInt), P(Size), P(Size)
)
glBindTextures = GL('glBindTextures', None, UInt, Int, P(UInt))
glBindSamplers = GL('glBindSamplers', None, UInt, Int, P(UInt))
glBindImageTextures = GL('glBindImageTextures', None, UInt, Int, P(UInt))
glBindVertexBuffers = GL(
