...
glMinSampleShading = GL('glMinSampleShading', None, Float)
glBlendEquationi = GL('glBlendEquationi', None, UInt, UInt)
glBlendEquationSeparatei = GL(
    'glBlendEquationSeparatei', None, UInt, UInt, UInt
)
glBlendFunci = GL('glBlendFunci', None, UInt, UInt, UInt)
glBlendFuncSeparatei = GL(
    'glBlendFuncSeparatei', None, UInt, UInt, UInt, UInt, UInt
)
glDrawArraysIndirect = GL('glDrawArraysIndirect', None, UInt, VoidP)
glDrawElementsIndirect = GL('glDrawElementsIndirect', None, UInt, UInt, VoidP)
glUniform1d = GL('glUniform1d', None, Int, Double)
glUniform2d = GL('glUniform2d', None, Int, Double, Double)
glUniform3d = GL('glUniform3d', None, Int, Double, Double, Double)
glUniform4d = GL('glUniform4d', None, Int, Double, Double, Double, Double)
glUniform1dv = GL('glUniform1dv', None, Int, Int, P(Double))
glUniform2dv = GL('glUniform2dv', None, Int, Int, P(Double))
glUniform3dv = GL('glUniform3dv', None, Int, Int, P(Double))
glUniform4dv = GL('glUniform4dv', None, Int, Int, P(Double))
glUniformMatrix2dv = GL(
    'glUniformMatrix2dv', None, Int, Int, UByte, P(Double)
)
glUniformMatrix3dv = GL(
    'glUniformMatrix3dv', None, Int, Int, UByte, P(Double)
)
glUniformMatrix4dv = GL(
    'glUniformMatrix4dv', None, Int, Int, UByte, P(Double)
)
glUniformMatrix2x3dv = GL(
    'glUniformMatrix2x3dv', None, Int, Int, UByte, P(Double)
)
glUniformMatrix2x4dv = GL(
    'glUniformMatrix2x4dv', None, Int, Int, UByte, P(Double)
)
glUniformMatrix3x2dv = GL(
    'glUniformMatrix3x2dv', None, Int, Int, UByte, P(Double)
)
glUniformMatrix3x4dv = GL(
    'glUniformMatrix3x4dv', None, Int, Int, UByte, P(Double)
)
glUniformMatrix4x2dv = GL(
    'glUniformMatrix4x2dv', None, Int, Int, UByte, P(Double)
)
glUniformMatrix4x3dv = GL(
    'glUniformMatrix4x3dv', None, Int, Int, UByte, P(Double)
)
glGetUniformdv = GL('glGetUniformdv', None, UInt, Int, P(Double))
glGetSubroutineUniformLocation = GL(
    'glGetSubroutineUniformLocation', Int, UInt, UInt, CharP
)
glGetSubroutineIndex = GL('glGetSubroutineIndex', UInt, UInt, UInt, CharP)
glGetActiveSubroutineUniformiv = GL(
    'glGetActiveSubroutineUniformiv', None, UInt, UInt, UInt, UInt, P(Int)
)
glGetActiveSubroutineUniformName = GL(
    'glGetActiveSubroutineUniformName', None, UInt, UInt, UInt, Int, P(Int),
    CharP
)
glGetActiveSubroutineName = GL(
    'glGetActiveSubroutineName', None, UInt, UInt, UInt, Int, P(Int), CharP
)
glUniformSubroutinesuiv = GL(
    'glUniformSubroutinesuiv', None, UInt, Int, P(UInt)
)
glGetUniformSubroutineuiv = GL(
    'glGetUniformSubroutineuiv', None, UInt, Int, P(UInt)
)
glGetProgramStageiv = GL(
    'glGetProgramStageiv', None, UInt, UInt, UInt, P(Int)
)
glPatchParameteri = GL('glPatchParameteri', None, UInt, Int)
glPatchParameterfv = GL('glPatchParameterfv', None, UInt, P(Float))
glBindTransformFeedback = GL('glBindTransformFeedback', None, UInt, UInt)
glDeleteTransformFeedbacks = GL(
    'glDeleteTransformFeedbacks', None, Int, P(UInt)
)
glGenTransformFeedbacks = GL('glGenTransformFeedbacks', None, Int, P(UInt))
glIsTransformFeedback = GL('glIsTransformFeedback', UByte, UInt)
glPauseTransformFeedback = GL('glPauseTransformFeedback', None)
glResumeTransformFeedback = GL('glResumeTransformFeedback', None)
glDrawTransformFeedback = GL('glDrawTransformFeedback', None, UInt, UInt)
glDrawTransformFeedbackStream = GL(
    'glDrawTransformFeedbackStream', None, UInt, UInt, UInt
)
glBeginQueryIndexed = GL('glBeginQueryIndexed', None, UInt, UInt, UInt)
glEndQueryIndexed = GL('glEndQueryIndexed', None, UInt, UInt)
glGetQueryIndexediv = GL(
    'glGetQueryIndexediv', None, UInt, UInt, UInt, P(Int)
)
