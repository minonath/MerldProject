...
glDrawArrays = GL('glDrawArrays', None, UInt, Int, Int)
glDrawElements = GL('glDrawElements', None, UInt, Int, UInt, VoidP)
glGetPointerv = GL('glGetPointerv', None, UInt, P(VoidP))
glPolygonOffset = GL('glPolygonOffset', None, Float, Float)
glCopyTexImage1D = GL(
...
glBindTexture = GL('glBindTexture', None, UInt, UInt)
glDeleteTextures = GL('glDeleteTextures', None, Int, P(UInt))
glGenTextures = GL('glGenTextures', None, Int, P(UInt))
glIsTexture = GL('glIsTexture', UByte, UInt)
