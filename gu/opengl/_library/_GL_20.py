...
glBlendEquationSeparate = GL('glBlendEquationSeparate', None, UInt, UInt)
glDrawBuffers = GL('glDrawBuffers', None, Int, P(UInt))
glStencilOpSeparate = GL('glStencilOpSeparate', None, UInt, UInt, UInt, UInt)
glStencilFuncSeparate = GL(
    'glStencilFuncSeparate', None, UInt, UInt, Int, UInt
)
glStencilMaskSeparate = GL('glStencilMaskSeparate', None, UInt, UInt)
glAttachShader = GL('glAttachShader', None, UInt, UInt)
glBindAttribLocation = GL('glBindAttribLocation', None, UInt, UInt, CharP)
glCompileShader = GL('glCompileShader', None, UInt)
glCreateProgram = GL('glCreateProgram', UInt)
glCreateShader = GL('glCreateShader', UInt, UInt)
glDeleteProgram = GL('glDeleteProgram', None, UInt)
glDeleteShader = GL('glDeleteShader', None, UInt)
glDetachShader = GL('glDetachShader', None, UInt, UInt)
glDisableVertexAttribArray = GL('glDisableVertexAttribArray', None, UInt)
glEnableVertexAttribArray = GL('glEnableVertexAttribArray', None, UInt)
glGetActiveAttrib = GL(
    'glGetActiveAttrib', None, UInt, UInt, Int, P(Int), P(Int), P(UInt), CharP
)
glGetActiveUniform = GL(
    'glGetActiveUniform', None, UInt, UInt, Int, P(Int), P(Int), P(UInt),
    CharP
)
glGetAttachedShaders = GL(
    'glGetAttachedShaders', None, UInt, Int, P(Int), P(UInt)
)
glGetAttribLocation = GL('glGetAttribLocation', Int, UInt, CharP)
glGetProgramiv = GL('glGetProgramiv', None, UInt, UInt, P(Int))
glGetProgramInfoLog = GL(
    'glGetProgramInfoLog', None, UInt, Int, P(Int), CharP
)
glGetShaderiv = GL('glGetShaderiv', None, UInt, UInt, P(Int))
glGetShaderInfoLog = GL('glGetShaderInfoLog', None, UInt, Int, P(Int), CharP)
glGetShaderSource = GL('glGetShaderSource', None, UInt, Int, P(Int), CharP)
glGetUniformLocation = GL('glGetUniformLocation', Int, UInt, CharP)
glGetUniformfv = GL('glGetUniformfv', None, UInt, Int, P(Float))
glGetUniformiv = GL('glGetUniformiv', None, UInt, Int, P(Int))
glGetVertexAttribdv = GL('glGetVertexAttribdv', None, UInt, UInt, P(Double))
glGetVertexAttribfv = GL('glGetVertexAttribfv', None, UInt, UInt, P(Float))
glGetVertexAttribiv = GL('glGetVertexAttribiv', None, UInt, UInt, P(Int))
glGetVertexAttribPointerv = GL(
    'glGetVertexAttribPointerv', None, UInt, UInt, P(VoidP)
)
glIsProgram = GL('glIsProgram', UByte, UInt)
glIsShader = GL('glIsShader', UByte, UInt)
glLinkProgram = GL('glLinkProgram', None, UInt)
glShaderSource = GL('glShaderSource', None, UInt, Int, P(CharP), P(Int))
glUseProgram = GL('glUseProgram', None, UInt)
glUniform1f = GL('glUniform1f', None, Int, Float)
glUniform2f = GL('glUniform2f', None, Int, Float, Float)
glUniform3f = GL('glUniform3f', None, Int, Float, Float, Float)
glUniform4f = GL('glUniform4f', None, Int, Float, Float, Float, Float)
glUniform1i = GL('glUniform1i', None, Int, Int)
glUniform2i = GL('glUniform2i', None, Int, Int, Int)
glUniform3i = GL('glUniform3i', None, Int, Int, Int, Int)
glUniform4i = GL('glUniform4i', None, Int, Int, Int, Int, Int)
glUniform1fv = GL('glUniform1fv', None, Int, Int, P(Float))
glUniform2fv = GL('glUniform2fv', None, Int, Int, P(Float))
glUniform3fv = GL('glUniform3fv', None, Int, Int, P(Float))
glUniform4fv = GL('glUniform4fv', None, Int, Int, P(Float))
glUniform1iv = GL('glUniform1iv', None, Int, Int, P(Int))
glUniform2iv = GL('glUniform2iv', None, Int, Int, P(Int))
glUniform3iv = GL('glUniform3iv', None, Int, Int, P(Int))
glUniform4iv = GL('glUniform4iv', None, Int, Int, P(Int))
glUniformMatrix2fv = GL('glUniformMatrix2fv', None, Int, Int, UByte, P(Float))
glUniformMatrix3fv = GL('glUniformMatrix3fv', None, Int, Int, UByte, P(Float))
glUniformMatrix4fv = GL('glUniformMatrix4fv', None, Int, Int, UByte, P(Float))
glValidateProgram = GL('glValidateProgram', None, UInt)
glVertexAttrib1d = GL('glVertexAttrib1d', None, UInt, Double)
glVertexAttrib1dv = GL('glVertexAttrib1dv', None, UInt, P(Double))
glVertexAttrib1f = GL('glVertexAttrib1f', None, UInt, Float)
glVertexAttrib1fv = GL('glVertexAttrib1fv', None, UInt, P(Float))
glVertexAttrib1s = GL('glVertexAttrib1s', None, UInt, Short)
glVertexAttrib1sv = GL('glVertexAttrib1sv', None, UInt, P(Short))
glVertexAttrib2d = GL('glVertexAttrib2d', None, UInt, Double, Double)
glVertexAttrib2dv = GL('glVertexAttrib2dv', None, UInt, P(Double))
glVertexAttrib2f = GL('glVertexAttrib2f', None, UInt, Float, Float)
glVertexAttrib2fv = GL('glVertexAttrib2fv', None, UInt, P(Float))
glVertexAttrib2s = GL('glVertexAttrib2s', None, UInt, Short, Short)
glVertexAttrib2sv = GL('glVertexAttrib2sv', None, UInt, P(Short))
glVertexAttrib3d = GL('glVertexAttrib3d', None, UInt, Double, Double, Double)
glVertexAttrib3dv = GL('glVertexAttrib3dv', None, UInt, P(Double))
glVertexAttrib3f = GL('glVertexAttrib3f', None, UInt, Float, Float, Float)
glVertexAttrib3fv = GL('glVertexAttrib3fv', None, UInt, P(Float))
glVertexAttrib3s = GL('glVertexAttrib3s', None, UInt, Short, Short, Short)
glVertexAttrib3sv = GL('glVertexAttrib3sv', None, UInt, P(Short))
glVertexAttrib4Nbv = GL('glVertexAttrib4Nbv', None, UInt, P(Byte))
glVertexAttrib4Niv = GL('glVertexAttrib4Niv', None, UInt, P(Int))
glVertexAttrib4Nsv = GL('glVertexAttrib4Nsv', None, UInt, P(Short))
glVertexAttrib4Nub = GL(
    'glVertexAttrib4Nub', None, UInt, UByte, UByte, UByte, UByte
)
glVertexAttrib4Nubv = GL('glVertexAttrib4Nubv', None, UInt, P(UByte))
glVertexAttrib4Nuiv = GL('glVertexAttrib4Nuiv', None, UInt, P(UInt))
glVertexAttrib4Nusv = GL('glVertexAttrib4Nusv', None, UInt, P(UShort))
glVertexAttrib4bv = GL('glVertexAttrib4bv', None, UInt, P(Byte))
glVertexAttrib4d = GL(
    'glVertexAttrib4d', None, UInt, Double, Double, Double, Double
)
glVertexAttrib4dv = GL('glVertexAttrib4dv', None, UInt, P(Double))
glVertexAttrib4f = GL(
    'glVertexAttrib4f', None, UInt, Float, Float, Float, Float
)
glVertexAttrib4fv = GL('glVertexAttrib4fv', None, UInt, P(Float))
glVertexAttrib4iv = GL('glVertexAttrib4iv', None, UInt, P(Int))
glVertexAttrib4s = GL(
    'glVertexAttrib4s', None, UInt, Short, Short, Short, Short
)
glVertexAttrib4sv = GL('glVertexAttrib4sv', None, UInt, P(Short))
glVertexAttrib4ubv = GL('glVertexAttrib4ubv', None, UInt, P(UByte))
glVertexAttrib4uiv = GL('glVertexAttrib4uiv', None, UInt, P(UInt))
glVertexAttrib4usv = GL('glVertexAttrib4usv', None, UInt, P(UShort))
