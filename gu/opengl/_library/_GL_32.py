...
PFNGLFENCESYNCPROC = C(GLSyncP, UInt, UInt)
PFNGLISSYNCPROC = C(UByte, GLSyncP)
PFNGLDELETESYNCPROC = C(None, GLSyncP)
PFNGLCLIENTWAITSYNCPROC = C(UInt, GLSyncP, UInt, ULong)
PFNGLWAITSYNCPROC = C(None, GLSyncP, UInt, ULong)
PFNGLGETINTEGER64VPROC = C(None, UInt, P(Long))
PFNGLGETSYNCIVPROC = C(None, GLSyncP, UInt, Int, P(Int), P(Int))
PFNGLGETINTEGER64I_VPROC = C(None, UInt, UInt, P(Long))
PFNGLGETBUFFERPARAMETERI64VPROC = C(None, UInt, UInt, P(Long))
...
glDrawElementsBaseVertex = GL(
    'glDrawElementsBaseVertex', None, UInt, Int, UInt, VoidP, Int
)
glDrawRangeElementsBaseVertex = GL(
    'glDrawRangeElementsBaseVertex', None, UInt, UInt, UInt, Int, UInt, VoidP,
    Int
)
glDrawElementsInstancedBaseVertex = GL(
    'glDrawElementsInstancedBaseVertex', None, UInt, Int, UInt, VoidP, Int,
    Int
)
glMultiDrawElementsBaseVertex = GL(
    'glMultiDrawElementsBaseVertex', None, UInt, P(Int), UInt, P(VoidP), Int,
    P(Int)
)
glProvokingVertex = GL('glProvokingVertex', None, UInt)
glFenceSync = GL('glFenceSync', GLSyncP, UInt, UInt)
glIsSync = GL('glIsSync', UByte, GLSyncP)
glDeleteSync = GL('glDeleteSync', None, GLSyncP)
glClientWaitSync = GL('glClientWaitSync', UInt, GLSyncP, UInt, ULong)
glWaitSync = GL('glWaitSync', None, GLSyncP, UInt, ULong)
glGetInteger64v = GL('glGetInteger64v', None, UInt, P(Long))
glGetSynciv = GL('glGetSynciv', None, GLSyncP, UInt, Int, P(Int), P(Int))
glGetInteger64i_v = GL('glGetInteger64i_v', None, UInt, UInt, P(Long))
glGetBufferParameteri64v = GL(
    'glGetBufferParameteri64v', None, UInt, UInt, P(Long)
)
glFramebufferTexture = GL('glFramebufferTexture', None, UInt, UInt, UInt, Int)
glTexImage2DMultisample = GL(
    'glTexImage2DMultisample', None, UInt, Int, UInt, Int, Int, UByte
)
glTexImage3DMultisample = GL(
    'glTexImage3DMultisample', None, UInt, Int, UInt, Int, Int, Int, UByte
)
glGetMultisamplefv = GL('glGetMultisamplefv', None, UInt, UInt, P(Float))
glSampleMaski = GL('glSampleMaski', None, UInt, UInt)
