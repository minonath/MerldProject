...
glDrawArraysInstanced = GL('glDrawArraysInstanced', None, UInt, Int, Int, Int)
glDrawElementsInstanced = GL(
    'glDrawElementsInstanced', None, UInt, Int, UInt, VoidP, Int
)
glTexBuffer = GL('glTexBuffer', None, UInt, UInt, UInt)
glPrimitiveRestartIndex = GL('glPrimitiveRestartIndex', None, UInt)
glCopyBufferSubData = GL(
    'glCopyBufferSubData', None, UInt, UInt, Size, Size, Size
)
glGetUniformIndices = GL(
    'glGetUniformIndices', None, UInt, Int, P(CharP), P(UInt)
)
glGetActiveUniformsiv = GL(
    'glGetActiveUniformsiv', None, UInt, Int, P(UInt), UInt, P(Int)
)
glGetActiveUniformName = GL(
    'glGetActiveUniformName', None, UInt, UInt, Int, P(Int), CharP
)
glGetUniformBlockIndex = GL('glGetUniformBlockIndex', UInt, UInt, CharP)
glGetActiveUniformBlockiv = GL(
    'glGetActiveUniformBlockiv', None, UInt, UInt, UInt, P(Int)
)
glGetActiveUniformBlockName = GL(
    'glGetActiveUniformBlockName', None, UInt, UInt, Int, P(Int), CharP
)
glUniformBlockBinding = GL('glUniformBlockBinding', None, UInt, UInt, UInt)
