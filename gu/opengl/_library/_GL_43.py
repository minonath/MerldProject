...
PFNGLGETINTERNALFORMATI64VPROC = C(None, UInt, UInt, UInt, Int, P(Long))
...
glClearBufferData = GL(
    'glClearBufferData', None, UInt, UInt, UInt, UInt, VoidP
)
glClearBufferSubData = GL(
    'glClearBufferSubData', None, UInt, UInt, Size, Size, UInt, UInt, VoidP
)
glDispatchCompute = GL('glDispatchCompute', None, UInt, UInt, UInt)
glDispatchComputeIndirect = GL('glDispatchComputeIndirect', None, Size)
glCopyImageSubData = GL(
    'glCopyImageSubData', None, UInt, UInt, Int, Int, Int, Int, UInt, UInt,
    Int, Int, Int, Int, Int, Int, Int
)
glFramebufferParameteri = GL('glFramebufferParameteri', None, UInt, UInt, Int)
glGetFramebufferParameteriv = GL(
    'glGetFramebufferParameteriv', None, UInt, UInt, P(Int)
)
glGetInternalformati64v = GL(
    'glGetInternalformati64v', None, UInt, UInt, UInt, Int, P(Long)
)
glInvalidateTexSubImage = GL(
    'glInvalidateTexSubImage', None, UInt, Int, Int, Int, Int, Int, Int, Int
)
glInvalidateTexImage = GL('glInvalidateTexImage', None, UInt, Int)
glInvalidateBufferSubData = GL(
    'glInvalidateBufferSubData', None, UInt, Size, Size
)
glInvalidateBufferData = GL('glInvalidateBufferData', None, UInt)
glInvalidateFramebuffer = GL(
    'glInvalidateFramebuffer', None, UInt, Int, P(UInt)
)
glInvalidateSubFramebuffer = GL(
    'glInvalidateSubFramebuffer', None, UInt, Int, P(UInt), Int, Int, Int, Int
)
glMultiDrawArraysIndirect = GL(
    'glMultiDrawArraysIndirect', None, UInt, VoidP, Int, Int
)
glMultiDrawElementsIndirect = GL(
    'glMultiDrawElementsIndirect', None, UInt, UInt, VoidP, Int, Int
)
glGetProgramInterfaceiv = GL(
    'glGetProgramInterfaceiv', None, UInt, UInt, UInt, P(Int)
)
glGetProgramResourceIndex = GL(
    'glGetProgramResourceIndex', UInt, UInt, UInt, CharP
)
glGetProgramResourceName = GL(
    'glGetProgramResourceName', None, UInt, UInt, UInt, Int, P(Int), CharP
)
glGetProgramResourceiv = GL(
    'glGetProgramResourceiv', None, UInt, UInt, UInt, Int, P(UInt), Int,
    P(Int), P(Int)
)
glGetProgramResourceLocation = GL(
    'glGetProgramResourceLocation', Int, UInt, UInt, CharP
)
glGetProgramResourceLocationIndex = GL(
...
glTexBufferRange = GL('glTexBufferRange', None, UInt, UInt, UInt, Size, Size)
glTexStorage2DMultisample = GL(
    'glTexStorage2DMultisample', None, UInt, Int, UInt, Int, Int, UByte
)
glTexStorage3DMultisample = GL(
    'glTexStorage3DMultisample', None, UInt, Int, UInt, Int, Int, Int, UByte
)
glTextureView = GL(
    'glTextureView', None, UInt, UInt, UInt, UInt, UInt, UInt, UInt, UInt
)
glBindVertexBuffer = GL('glBindVertexBuffer', None, UInt, UInt, Size, Int)
glVertexAttribFormat = GL(
    'glVertexAttribFormat', None, UInt, Int, UInt, UByte, UInt
)
glVertexAttribIFormat = GL(
    'glVertexAttribIFormat', None, UInt, Int, UInt, UInt
)
glVertexAttribLFormat = GL(
    'glVertexAttribLFormat', None, UInt, Int, UInt, UInt
)
glVertexAttribBinding = GL('glVertexAttribBinding', None, UInt, UInt)
glVertexBindingDivisor = GL('glVertexBindingDivisor', None, UInt, UInt)
glDebugMessageControl = GL(
    'glDebugMessageControl', None, UInt, UInt, UInt, Int, P(UInt), UByte
)
glDebugMessageInsert = GL(
    'glDebugMessageInsert', None, UInt, UInt, UInt, UInt, Int, CharP
)
glDebugMessageCallback = GL(
    'glDebugMessageCallback', None, GLDEBUGPROC, VoidP
)
glGetDebugMessageLog = GL(
    'glGetDebugMessageLog', UInt, UInt, Int, P(UInt), P(UInt), P(UInt),
    P(UInt), P(Int), CharP
)
glPushDebugGroup = GL('glPushDebugGroup', None, UInt, UInt, Int, CharP)
glPopDebugGroup = GL('glPopDebugGroup', None)
glObjectLabel = GL('glObjectLabel', None, UInt, UInt, Int, CharP)
glGetObjectLabel = GL(
    'glGetObjectLabel', None, UInt, UInt, Int, P(Int), CharP
)
glObjectPtrLabel = GL('glObjectPtrLabel', None, VoidP, Int, CharP)
glGetObjectPtrLabel = GL(
